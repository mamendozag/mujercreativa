...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'diablodesign-nostyle';
  $styles = array(
    'diablodesign-nostyle' => 'modChrome_artnostyle',
    'diablodesign-block' => 'modChrome_artblock',
    'diablodesign-article' => 'modChrome_artarticle',
    'diablodesign-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'diablodesign-...'        - overwrites the default module style.
  //  'suffix diablodesign-...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add diablodesign-... to the module elements.
...
<!-- begin nostyle -->
<div class="diablodesign-nostyle<?php echo $params->get('moduleclass_sfx'); ?>">
